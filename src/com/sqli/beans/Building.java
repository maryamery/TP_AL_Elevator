...
public class Building {
    ...
    public String requestElevator() {
        return availableElevator.getIdOfFirstAvailableElevator(numberOfFloors,elevators,0);
    }
    public String requestElevator(int i) {
        return availableElevator.getIdOfFirstAvailableElevator(i,elevators,numberOfFloors);
    }
